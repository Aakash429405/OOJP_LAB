import java.io.*;
 import java.lang.*; import java.util.*; public class cie_and_see 
{ 
    private static  double cie;     private static double see;     public static void read() 
    { 
        Scanner sc=new Scanner(System.in); 
        System.out.println("Enter the CIE marks out of 50"); 
        cie=sc.nextFloat(); 
 
        System.out.println("Enter the SEE marks out of 100");         see=sc.nextFloat(); 
    } 
 
    public static void calc() 
    {         read(); 
        double total=Math.round(cie+((see)/2));         System.out.println("Total marks obtained is " + total);         if(total>=90&&total<=100) 
        { 
